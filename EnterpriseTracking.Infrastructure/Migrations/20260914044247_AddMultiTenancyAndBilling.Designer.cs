...
namespace EnterpriseTracking.Infrastructure.Migrations
{
    ...
    [Migration("20260914044247_AddMultiTenancyAndBilling")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnterpriseTracking.Core.Entities.ActivityCategory", b =>
                {
            ...
            modelBuilder.Entity("EnterpriseTracking.Core.Entities.AgentSession", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EnterpriseTracking.Core.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("IsVoucherLinked")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("EnterpriseTracking.Core.Entities.ProofOfActivity", b =>
                {
                    ...
                    b.Property<string>("MapCategoryId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("ProofOfActivitys");
                });

            modelBuilder.Entity("EnterpriseTracking.Core.Entities.ThirdPartyClient", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
                    ...
                    b.ToTable("ThirdPartyClients");
                });

            modelBuilder.Entity("EnterpriseTracking.Core.Entities.UserActivity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EnterpriseTracking.Core.Entities.ProofOfActivity", b =>
                {
                    b.HasOne("EnterpriseTracking.Core.Entities.MapAppCatories", "MapCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EnterpriseTracking.Core.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EnterpriseTracking.Core.Entities.ActivityCategory", b =>
                {
                    b.Navigation("MappAppCategories");
                });
